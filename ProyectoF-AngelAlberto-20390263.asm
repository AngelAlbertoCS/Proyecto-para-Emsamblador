...
section .data
    ...
    msgresult db 10, 13, 7, "El resultado es: "
    result db 0 
    ...
    digitos times 10 db 0     ; Array para almacenar los dígitos descompuestos
...
op_1:
    ...
    imprime2 msgresult, 20

    ; Imprimir el contenido en pantalla
    mov rax, 1
    mov rdi, 1           ; STDOUT (pantalla)
    mov rsi, resultado            ; Dirección de la matriz
    syscall
...
op_2:
    ...
    ; Convertir el valor ASCII en número decimal
    sub eax, '0'
